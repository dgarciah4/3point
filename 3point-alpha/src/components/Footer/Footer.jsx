...
import Logo from './3Point_Footer.svg'
  ...
  <div class="flex">
      <a href="#!" class="mr-6 mt-6 text-neutral-600 dark:text-neutral-200">
        <svg
  ...
  <div className ='mx-6 py-10 text-center md:text-left lg:text-center grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4'>      
        ...
        <div className = "">
          <p className="mb-4">
          <a href="#!" className="text-neutral-600 hover:text-gold dark:text-neutral-200"
            >The Lab</a
          >
        </p>
        <p class="mb-4">
        ...
        <p className='mb-4'>
          ...
          >
            ...
            <div className='bg-transparent p-6 fixed bottom-0 lg:text-center dark:bg-transparent'>
            
            <p className='flex y-0 justify-center items-center font-semibold
              text-bottom mx-auto text-neutral-600 dark:text-neutral-200'>
